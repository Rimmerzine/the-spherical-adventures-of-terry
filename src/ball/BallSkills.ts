class BallSkills {
    ...
    getSkill(name: "max-rps" | "acceleration" | "grip" | "shock-absorber" | "jumps"): BallSkill {
...
class BallSkill {
    ...
    constructor(startingValue: number, upgradeIncrement: number, upgradeCosts: Array<number>) {
